...
int main(){
    ...
    Order orderA = create_order(111, 2019, 3, 25, "Rebecca Raspberry", 6.10);
    Order orderB = create_order(116, 2019, 3, 29, "Fiona Framboise", 17.0);
    ...
    //Change the date of orderB to be March 12th, 2016
    change_date(&orderB, 2016, 3, 12);
